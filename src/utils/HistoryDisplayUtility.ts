...
const HistoryDisplayUtility = {
     ...
     */
    formatDateValue(value: string | null | undefined): string | null {
    ...
    formatCleanlinessRating(value: string | number | null | undefined): string | null {
    ...
    formatAssignmentValue(value: string | null | undefined): string | null {
        if (value && ['0', 'null', 'undefined'].includes(value)) return 'None'
        return null
    },

    /** Compares two dates by their date-only (YYYY-MM-DD) components. */
    areSameDates(date1: string | Date | null | undefined, date2: string | Date | null | undefined): boolean {
