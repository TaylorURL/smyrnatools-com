...
/**
 * Per-customer realtime presence for the Operations → Call List detail
 * view. Joins a Supabase Realtime Presence channel keyed by
 ...
 */
export function useCallListCustomerPresence(customerNum, { userId = null } = {}) {
...
export default useCallListCustomerPresence
