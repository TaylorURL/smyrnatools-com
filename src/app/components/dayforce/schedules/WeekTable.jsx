 ...
 *
 *  When `bare` is true the Panel wrapper is omitted so the table can
 *  embed inside an outer surface that owns the title + chrome (e.g. the
 *  Schedules carousel, which puts the week label + nav controls in its
 *  own Panel header). */
