...
const ErrorIconBadge = () => (
    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-red-100 rounded-full flex items-center justify-center shrink-0">
        <i className="fas fa-exclamation-triangle text-text-primary text-base sm:text-lg" />
    </div>
)
...
const CommentExamplesGrid = () => (
    <div className="grid grid-cols-2 gap-2 sm:gap-3 bg-green-50 rounded-lg p-3 sm:p-4 mb-4">
        <div>
            <div className="text-text-primary text-[10px] sm:text-[11px] font-bold mb-1 flex items-center">
                <i className="fas fa-check mr-1" />
                VALID
            </div>
            <div className="text-text-primary text-[11px] sm:text-xs">
                {'"Sent to plant 402"'}
                <br />
                {'"Truck breakdown"'}
            </div>
            ...
            <div className="bg-bg-primary rounded-2xl p-4 sm:p-6 max-w-md w-full shadow-2xl">
                <div className="flex items-center gap-3 mb-4 sm:mb-5">
                    ...
                    <div className="min-w-0">
                        ...
                        {isCommentError && (
                            <p className="text-xs sm:text-sm text-text-primary font-medium m-0 mt-0.5">
                ...
                {isCommentError ? (
                    <>
                        <div className="bg-red-50 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
                            <div className="text-text-primary text-xs sm:text-sm font-medium mb-2">
                                {parsed.message}
                            </div>
                            {parsed.hasComment && (
                    ...
                    <div className="bg-red-50 rounded-lg p-3 sm:p-4 mb-4">
                        <div className="text-text-primary text-xs sm:text-sm font-medium">{error}</div>
                    </div>
                )}
