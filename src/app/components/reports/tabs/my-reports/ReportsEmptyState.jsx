...
const TipCard = ({ icon, title, text }) => (
    <div className="flex items-center gap-3 bg-slate-50 border border-gray-200 rounded-lg p-3 sm:p-4 text-left">
        <i className={`fas ${icon} text-text-primary text-lg sm:text-xl shrink-0`} />
        <div>
...
const NoAssignmentsState = () => (
    <div className="flex flex-col items-center bg-bg-primary border border-gray-200 rounded-lg sm:rounded-2xl p-6 sm:p-12 text-center">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 max-w-sm text-left">
            ...
            <p className="text-xs sm:text-sm text-text-secondary leading-relaxed m-0 mt-2">
...
const AllCaughtUpState = () => (
    <div className="flex flex-col items-center bg-bg-primary border border-gray-200 rounded-lg sm:rounded-2xl p-6 sm:p-12 text-center">
        <IconWrapper icon="fa-check-circle" iconColorClass="text-text-primary" />
...
const ReviewEmptyState = () => (
    <div className="flex flex-col items-center bg-bg-primary border border-gray-200 rounded-lg sm:rounded-2xl p-6 sm:p-12 text-center">
        ...
        <div className="flex items-start gap-3 bg-sky-50 border border-sky-200 rounded-lg p-4 max-w-md text-left">
            <i className="fas fa-info-circle text-text-primary text-lg shrink-0 mt-0.5" />
