    ...
    return (
        <div className="mb-5">
            ...
            <select
                ...
                aria-label="Region"
                className="w-full cursor-pointer appearance-none rounded-[10px] border-2 border-border-light bg-bg-secondary p-3 text-sm font-semibold text-text-primary transition-[border-color,box-shadow] duration-200 ease-out motion-reduce:transition-none hover:border-border-medium focus-visible:border-accent focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-accent/15"
                value={regionCode || ''}
                onChange={onChange}
                style={{
                    backgroundImage: MOBILE_SELECT_ARROW,
