...
export const TimeInput = ({ value, onChange, placeholder = 'HH:MM', className = '' }) => (
    <input
        ...
        className={`border rounded-md text-xs outline-none font-mono tabular-nums text-center py-1 px-1 w-[56px] bg-bg-primary border-border-medium text-text-primary transition-colors duration-150 placeholder:text-text-tertiary hover:border-text-tertiary focus-visible:outline-none focus-visible:border-accent focus-visible:ring-2 focus-visible:ring-accent/30 ${className}`}
    />
)
