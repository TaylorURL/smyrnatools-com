 ...
 */
function MilitaryTimeInput({ compact = false, onChange, value }) {
    ...
    const baseClass =
        'w-full rounded-lg text-sm border font-mono tabular-nums bg-bg-primary border-border-medium text-text-primary'
